...
struct StoryBrain {
    ...
    var storyNumber = 0
    var pressed1Destination = 0
    var pressed2Destination = 0
    let story = [
    ...
    mutating func checkAnswer(userChoice: String) {
        pressed1Destination = story[storyNumber].choice1Destination
        pressed2Destination = story[storyNumber].choice2Destination
        
  
        if userChoice == story[storyNumber].choice1 {storyNumber = pressed1Destination}
     else {storyNumber = pressed2Destination}
    }
